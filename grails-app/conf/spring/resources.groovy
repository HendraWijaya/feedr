...
beans =  {
    ...
    httpSyndFeedReceiver(feedr.fetcher.HttpSyndFeedReceiver) {
        syndFeedReceiver = itemService
    }
    
    httpFeedFetcher(feedr.fetcher.HttpFeedFetcher) {
        httpFeedReceiver = httpSyndFeedReceiver
    }
	...
	switch(Environment.current) {
		...
		schedulerFactoryBean(org.springframework.scheduling.quartz.SchedulerFactoryBean) {
			triggers = [feedBotJobTrigger, itemBotJobTrigger]
		}
		break
	}
}
