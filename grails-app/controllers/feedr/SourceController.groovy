      ...
      if (source) {
         if (params.version) {
            ...
            if (source.version > version) {
               ...
               source.errors.rejectValue("version", "default.optimistic.locking.failure", [
                  message(code: 'source.label', default: 'source')]
               as Object[], "Another user has updated this source while you were editing")
